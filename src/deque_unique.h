...
class DequeOfUniquePairs {
 public:
  ...
  DequeOfUniquePairs() = default;

  DequeOfUniquePairs(const std::initializer_list<std::pair<T1, T2>>& initializer):DequeOfUniquePairs(initializer.begin(), initializer.end()){};

  DequeOfUniquePairs(const DequeOfUniquePairs& other)=default;
